        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    console.log("4. Exit");
                    return [4 /*yield*/, promptUser("Enter your choice: ")];
                case 2:
                    choice = _b.sent();
                    _a = choice;
                    switch (_a) {
                    ...
                    return [3 /*break*/, 11];
                case 3: return [4 /*yield*/, promptUser("Enter note title: ")];
                case 4:
                    title = _b.sent();
                    return [4 /*yield*/, promptUser("Enter note content: ")];
                case 5:
                    content = _b.sent();
                    noteManager.addNote(title, content);
                    return [3 /*break*/, 12];
                case 6: return [4 /*yield*/, promptUser("Enter title of the note to edit: ")];
                case 7:
                    noteTitle = _b.sent();
                    return [4 /*yield*/, promptUser("Enter new content: ")];
                case 8:
                    newContent = _b.sent();
                    try {
